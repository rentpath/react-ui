...
var PageView = function (_PureComponent) {
  ...
  function PageView(props, context) {
    ...
    var _this = _possibleConstructorReturn(this, (PageView.__proto__ || Object.getPrototypeOf(PageView)).call(this, props, context));
...
PageView.contextTypes = {
  tracker: _propTypes2.default.shape({
    pageView: _propTypes2.default.func.isRequired
  })
};
