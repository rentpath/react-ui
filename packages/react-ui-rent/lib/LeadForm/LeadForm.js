...
var FIELD_MAPPING = {
  ...
  move_date: _Fields.MoveInDate
};

var FIELDS = [{ name: 'message' }, { name: 'name' }, { name: 'email' }, { name: 'phone' }, { name: 'move_date' }, { name: 'submit' }, { name: 'opt_in_newsletter' }, { name: 'terms_of_service' }];

var LeadForm = (_dec = (0, _reactThemed2.default)('*'), _dec(_class = (_temp = _class2 = function (_Component) {
  ...
  (0, _createClass3.default)(LeadForm, [{
    ...
    get: function get() {
      ...
      return fields.map(function (fieldComposition) {
        ...
        var name = props.name;
        var FormField = field || FIELD_MAPPING[name] || _reactUiCore.Field;
