...
var CancelButton = (_dec = (0, _reactThemed2.default)(['CancelButton'], {
  pure: true
}), _dec(_class = (_class2 = (_temp = _class3 = function (_PureComponent) {
  (0, _inherits3.default)(CancelButton, _PureComponent);

  function CancelButton() {
    (0, _classCallCheck3.default)(this, CancelButton);
    return (0, _possibleConstructorReturn3.default)(this, (CancelButton.__proto__ || (0, _getPrototypeOf2.default)(CancelButton)).apply(this, arguments));
  }
  ...
  (0, _createClass3.default)(CancelButton, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          props = (0, _objectWithoutProperties3.default)(_props, ['theme', 'name', 'className', 'onClick']);
      ...
      return _react2.default.createElement(
        _reactUiCore.Button,
        (0, _extends3.default)({
          className: (0, _classnames2.default)(theme.CancelButton, className),
