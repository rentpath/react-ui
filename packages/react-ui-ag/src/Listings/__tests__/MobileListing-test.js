...
import ThemedMobileListing from '../Listing'
...
describe('ag/Listings/MobileListing', () => {
  describe('ctaButtons', () => {
    let wrapper
    let ctaClick
    let cardClick
  ...
  it('sets the favorite button to favorited when the listing has isFavorited as true', () => {
    ...
    const wrapper = shallow(<MobileListing {...favoritedProps} />)
  ...
  describe('photos', () => {
    it('renders a component with a PhotoCarousel if active', () => {
      const wrapper = shallow(<MobileListing {...props} />)
    ...
    it('renders a component with one background image if inactive', () => {
      const wrapper = shallow(<MobileListing {...props} isActive={false} />)
    ...
    it('renders a photo component even without a listing photos array', () => {
      ...
      const wrapper = shallow(<MobileListing {...omittedPhotoProps} isActive={false} />)
