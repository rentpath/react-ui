...
import ThemedDesktopListingInfo from '../DesktopListingInfo'
import theme from './mocks/theme'

const DesktopListingInfo = ThemedDesktopListingInfo.WrappedComponent
...
describe('ag/Listings/DesktopListingInfo', () => {
  describe('components render', () => {
    it('renders Price component', () => {
      const wrapper = mount(<DesktopListingInfo {...props} />)
  ...
  describe('single family components render', () => {
    it('renders Price component', () => {
      const wrapper = mount(<DesktopListingInfo {...singleFamilyProps} />)
      expect(wrapper.find(ListingComponents.Price).exists()).toBeTruthy()
    })
