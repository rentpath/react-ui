...
export default class RadioGroupDropdown extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <RadioGroupDropdownFilterCardWrapper
          {...props}
...
RadioGroupDropdownAnchorTextComponent.defaultProps = {
  defaultText: '',
  icon: '⌄',
}

export const RadioGroupDropdownAnchorText = themed('*')(RadioGroupDropdownAnchorTextComponent)
