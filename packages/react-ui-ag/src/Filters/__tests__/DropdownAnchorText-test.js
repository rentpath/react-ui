...
describe('DropdownAnchorText', () => {
  it('contains text that is passed in', () => {
    const wrapper = mount(
      <div>
        <DropdownAnchorText text="Bar" defaultText="Foo" />
      </div>
    )
  ...
  it('contains defaultText if no text is passed', () => {
    const wrapper = mount(
      <div>
        <DropdownAnchorText defaultText="Foo" />
      </div>
    )
  ...
  it('contains defaultText if text is null', () => {
    const wrapper = mount(
      <div>
        <DropdownAnchorText text={null} defaultText="Foo" />
      </div>
    )
    expect(wrapper.text()).toContain('Foo')
  })
  ...
  it('allows a string to be passed to icon', () => {
    const wrapper = mount(
      <div>
        <DropdownAnchorText defaultText="Foo" icon="Stuff" />
      </div>
    )
  ...
  it('allows html to be passed to icon', () => {
    ...
    const wrapper = mount(
      <div>
        <DropdownAnchorText defaultText="Foo" icon={icon} />
      </div>
    )
