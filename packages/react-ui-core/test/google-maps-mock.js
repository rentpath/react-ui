// Found at: https://github.com/prasathmani/google-maps-mock-api
...
GoogleApiMock = (function() {
  ...
  if (!event.addDomListener) {
      ...
      event.addListenerOnce = function(thing, eventName, callBack) {
      callBack();
        event.addDomListener(thing, eventName, callBack);
        return callBack
      };
  }
  ...
  return window.google.maps.Polygon = function(options) {
      ...
      return (options.paths && options.paths[0]) || options.path;
      };
