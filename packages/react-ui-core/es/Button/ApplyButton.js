...
var ApplyButton = (_dec = themed(['ApplyButton'], {
  pure: true
}), _dec(_class = (_class2 = (_temp = _class3 =
/*#__PURE__*/
function (_PureComponent) {
  _inherits(ApplyButton, _PureComponent);

  function ApplyButton() {
    _classCallCheck(this, ApplyButton);

    return _possibleConstructorReturn(this, _getPrototypeOf(ApplyButton).apply(this, arguments));
  }
  ...
  _createClass(ApplyButton, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["theme", "className", "onClick", "children", "value"]);

      if (!onClick) return null;
      return React.createElement(Button, _extends({
        className: classnames(theme.ApplyButton, className),
