...
var Label = (_dec = (0, _reactThemed2.default)(/^Label/, {
  pure: true
  ...
  (0, _createClass3.default)(Label, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          props = (0, _objectWithoutProperties3.default)(_props, ['text', 'theme', 'className', 'children']);


      var classnames = (0, _classnames2.default)(className, theme.Label);
