...
var CancelButton = (_dec = (0, _reactThemed.default)(['CancelButton'], {
  pure: true
}), _dec(_class = (_class2 = (_temp = _class3 =
/*#__PURE__*/
function (_PureComponent) {
  (0, _inherits2.default)(CancelButton, _PureComponent);

  function CancelButton() {
    (0, _classCallCheck2.default)(this, CancelButton);
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(CancelButton).apply(this, arguments));
  }

  (0, _createClass2.default)(CancelButton, [{
    key: "handleClick",
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = (0, _objectWithoutProperties2.default)(_this$props, ["theme", "className", "onClick", "children"]);
      if (!onClick) return null;
      return _react.default.createElement(_Button.default, (0, _extends2.default)({
        className: (0, _classnames.default)(theme.CancelButton, className),
